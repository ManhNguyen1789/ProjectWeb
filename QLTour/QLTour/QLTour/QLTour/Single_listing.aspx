                    ...
                    <div class="reviews_container">
                            ...
                            <div class="row">
                                <div class="col-lg-1">
                                    <div class="review_image">
                                        <img src="Template/images/review_1.jpg" alt="https://unsplash.com/@saaout">
                                    </div>
                                </div>
                                <div class="col-lg-11">
                                    <div class="review_content">
                                        ...
                                        <div class="review_text">
                                            <p>Lúc đầu không tin tưởng về chất lượng nhưng sau khi dùng thử với ưu đãi của shop thì chúng tôi hoàn toàn tin về tránh nhiệm của shop với khách hàng.</p>
                                        </div>
                                        <div class="review_name">Christinne Smith</div>
                                        <div class="review_date">12 Tháng 11 2017</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="review">
                            <div class="row">
                                <div class="col-lg-1">
                                    <div class="review_image">
                                        <img src="Template/images/review_2.jpg" alt="Image by Andrew Robles">
                                    </div>
                                </div>
                                <div class="col-lg-11">
                                    <div class="review_content">
                                        <div class="review_title_container">
                                            <div class="review_title">"Thật tuyệt, nhân viên rất nhiệt tình"</div>
                                            <div class="review_rating">9.5</div>
                                        </div>
                                        <div class="review_text">
                                            <p>Nhân viên shop đã hỗ trợ tôi khi tôi không biết quy trình đặt tour cho gia đình hết lòng giúp đỡ, đưa ra các office hấp dẫn và phù hợp cho chúng tôi.</p>
                                        </div>
                                        <div class="review_name">Christinne Smith</div>
                                        <div class="review_date">12 tháng 11 2017</div>
                                    </div>
