            ...
            <ul class="offers_sorting">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><span>
                            <asp:LinkButton runat="server" ID="lbtnkhbookall">TẤT CẢ KHÁCH HÀNG</asp:LinkButton></span></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li><span>
                            <asp:LinkButton runat="server" ID="lbtnnhnvienbanmax" OnClick="lbtnnhnvienbanmax_Click">NV SELL MAX</asp:LinkButton></span></li>
                        <li><span>
                            <asp:LinkButton runat="server" ID="lbtnnhanvienbanmin" OnClick="lbtnnhanvienbanmin_Click">NV SELL MIN</asp:LinkButton></span></li>
                        <li><span>
                            <asp:LinkButton runat="server" ID="lbtnBW2T5T">NV SELL > 300TR</asp:LinkButton></span></li>
                        <li><span>
                            <asp:LinkButton runat="server" ID="lbtnTren5T">NV SELL < 100TR</asp:LinkButton></span></li>
                    </ul>
                </li>
