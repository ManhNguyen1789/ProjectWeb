            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        cmbGio.Text = obj.NgayKT.Value.Hour.ToString();
                        cmbPhutbd.Text = obj.NgayBD.Value.Minute.ToString();
                        cmbPhut.Text = obj.NgayKT.Value.Minute.ToString();
                        cmbslot.SelectedValue = obj.Slot.ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string giobd = cmbGiobd.SelectedValue + ":" + cmbPhutbd.SelectedValue;
                    obj.NgayBD = Convert.ToDateTime(ngaybd + " " + giobd);
                    string giokt = cmbGio.SelectedValue + ":" + cmbPhut.SelectedValue;
                    ...
                    obj.Slot = Int32.Parse(cmbslot.SelectedValue);
