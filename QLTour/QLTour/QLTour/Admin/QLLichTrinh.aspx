            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="form-horizontal">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Số chỗ còn lại (SLOT)  <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <asp:DropDownList runat="server" ID="cmbslot" class="form-control m-b" Width="500">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
